  ...
  */
  ...
  render() {
    /*
        ...
        자식 컴포넌트에서는 this.props.변수형 형식으로 변수를 사용

        코드가 번잡스러워지기 때문에
        부모컨테이너에서 비구조화 작업을 수행한 후
        변수를 전달해 주도록 한다.
  ...
  // componentDidMount()에서 호출되는 method
  fetchBBsList = () => {
    fetch(BBS_FETCH_URL)
      .then((res) => {
  ...
  // LifeCycle mehtod에서 현재 화면의 DOM들이
