...
class BBsWrite extends Component {
  ...
  /*
    react에서는 input 박스에 state 변수를 value값으로 세팅하면
    * 데이터를 외부에서 불러오거나 했을 때 자동으로 해당 input 박스에
    ...
    문제는
    input box가 1,2개 정도이면 각각의 input box에 event핸들러를 부착하여
    작동시키면 되는데
    input box가 많아지면 관리가 힘들고 input box의 추가나 변경이 발생했을 때
    유지보수가 매우 어려워 진다.

    그래서 여러개의 input box가 잇을경우
    1개의 event 핸들러를 작성하고
    공통으로 활용하는 방법이 주로 사용된다.
  */
  handelChangebbsDate = (e) => {
    this.setState({
